...
export default function AdminToursPage() {
  ...
  const handleToggleApproval = async (tour: (typeof tours)[0]) => {
    setActionLoading(tour._id);
    const newStatus = tour.status === "approved" ? "rejected" : "approved";
    await dispatch(updateTourStatus({ id: tour._id, status: newStatus }));
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <p className="text-gray-500 mt-1">
            Review, approve and manage all tours
          </p>
        </div>
            ...
            >
              ...
              <div className="p-4 flex flex-col flex-1 justify-between">
                <div>
                  ...
                  <span
                    className={`inline-block mt-2 text-xs font-semibold px-3 py-1 rounded-full ${tour.status === "approved"
                ...
                <div className="mt-4 flex flex-wrap gap-2">
                  {/* Approve / Reject */}
                  <button
                    onClick={() => handleToggleApproval(tour)}
                    disabled={actionLoading === tour._id}
                    className={`flex-1 px-3 py-2 rounded-lg text-white text-sm font-semibold transition ${tour.status === "approved"
                  ...
                  <button
                    ...
                    className={`px-3 py-2 rounded-lg text-white text-sm font-semibold ${tour.isActive
                  ...
                  <button
                    ...
                    className={`px-3 py-2 rounded-lg text-white text-sm font-semibold ${tour.isFeatured
